                    ...
                    <div className="card-premium">
                        ...
                        {canEdit && !isSold ? (
                            <form onSubmit={handleFinancialSubmit} className="space-y-3">
                                ...
                                <div><label className="label-premium">Type</label><select value={finData.type} onChange={e => setFinData('type', e.target.value)} className="select-premium"><option value="food">Nourriture</option><option value="veterinaire">Vétérinaire</option><option value="autre">Autre</option>{vache.sexe !== 'male' && <option value="gain">Production lait (L)</option>}<option value="lait_consomme">Lait consommé (L)</option></select></div>
